...
function changeColor() {
    const itemList = /* Get the list with the id 'item-list' */;
    const items = /* Get all the items with the class name 'number-item */;
    for (let i = 0; i < items.length; i++) {
        // Toogle the 'colored' class in each of the items
    }
}
